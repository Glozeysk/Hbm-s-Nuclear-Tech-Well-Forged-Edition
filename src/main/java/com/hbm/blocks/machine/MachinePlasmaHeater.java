...
public class MachinePlasmaHeater extends BlockDummyable {
	...
	public void breakBlock(World world, BlockPos pos, IBlockState state) {
		...
		if(i >= 12) {
        	world.spawnEntity(new EntityItem(world, pos.getX() + 0.5, pos.getY() + 0.5, pos.getZ() + 0.5, new ItemStack(ModBlocks.plasma_heater, 1)));
    	}
	...
	protected boolean checkRequirement(World world, int x, int y, int z, ForgeDirection dir, int o) {
		...
		if(!MultiblockHandlerXR.checkSpace(world, x + dir.offsetX * o , y + dir.offsetY * o, z + dir.offsetZ * o, new int[] {4, -3, 2, 1, 1, 1}, x, y, z, dir))
			return false;
