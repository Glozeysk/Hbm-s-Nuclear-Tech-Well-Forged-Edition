...
public class MachineExcavator extends BlockDummyable {
	...
	protected boolean checkRequirement(World world, int x, int y, int z, ForgeDirection dir, int o) {
		...
		if(!MultiblockHandlerXR.checkSpace(world, x, y, z, getDimensions(), x, y, z, dir))
			return false;
		if(!MultiblockHandlerXR.checkSpace(world, x, y, z, new int[] {-1, 3, 3, -2, 3, -2}, x, y, z, dir))
			return false;
		if(!MultiblockHandlerXR.checkSpace(world, x, y, z, new int[] {-1, 3, 3, -2, -2, 3}, x, y, z, dir))
			return false;
		if(!MultiblockHandlerXR.checkSpace(world, x, y, z, new int[] {-1, 3, -2, 3, 3, 3}, x, y, z, dir))
			return false;
