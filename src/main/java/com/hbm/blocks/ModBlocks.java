...
import com.hbm.blocks.bomb.DetMiner2;
import com.hbm.blocks.bomb.DetMiner3;
import com.hbm.blocks.bomb.DetMiner4;
...
import com.hbm.blocks.machine.dummy.*;
...
public class ModBlocks {
	...
	public static final Block reinforced_brick_stairs = new BlockGenericStairs(reinforced_brick.getDefaultState(), "reinforced_brick_stairs").setCreativeTab(MainRegistry.blockTab).setLightOpacity(0).setHardness(15.0F).setResistance(6000.0F);
	...
	public static final Block reinforced_sand_stairs = new BlockGenericStairs(reinforced_sand.getDefaultState(), "reinforced_sand_stairs").setCreativeTab(MainRegistry.blockTab).setLightOpacity(0).setHardness(15.0F).setResistance(300.0F);
	public static final Block brick_obsidian_stairs = new BlockGenericStairs(brick_obsidian.getDefaultState(), "brick_obsidian_stairs").setCreativeTab(MainRegistry.blockTab).setLightOpacity(0).setHardness(15.0F).setResistance(6000.0F);
	...
	public static final Block ore_schrabidium = new BlockNTMOre("ore_schrabidium", 4, 300).addRadiation(ItemHazard.ore * ItemHazard.sa326).addBlinding().toBlock().setHardness(15.0F).setResistance(600.0F).setCreativeTab(MainRegistry.resourceTab);
	...
	public static final Block ore_gneiss_schrabidium = new BlockNTMOre("ore_gneiss_schrabidium", 4).addRadiation(ItemHazard.ore * ItemHazard.sa326).addBlinding().toBlock().setCreativeTab(MainRegistry.resourceTab).setHardness(1.5F).setResistance(10.0F);
	...
	public static final Block ore_nether_plutonium = new BlockNTMOre("ore_nether_plutonium", 4).addRadiation(ItemHazard.pu).toBlock().setCreativeTab(MainRegistry.resourceTab).setHardness(0.4F).setResistance(10.0F);
	public static final Block ore_nether_schrabidium = new BlockNTMOre("ore_nether_schrabidium", 4).addRadiation(ItemHazard.ore * ItemHazard.sa326).addBlinding().toBlock().setHardness(15.0F).setResistance(600.0F).setCreativeTab(MainRegistry.resourceTab);
	...
	public static final Block ore_meteor_starmetal = new BlockNTMOre("ore_meteor_starmetal", 4, 60).setCreativeTab(MainRegistry.resourceTab).setHardness(10.0F).setResistance(100.0F);
	...
	public static final Block block_cadmium = new BlockHazard(Material.IRON, "block_cadmium").addToxic(7).toBlock().setCreativeTab(MainRegistry.blockTab).setHardness(5.0F).setResistance(30.0F);
	...
	public static final Block block_beryllium = new BlockHazard(Material.IRON, "block_beryllium").addToxic(5).toBlock().setCreativeTab(MainRegistry.blockTab).setHardness(5.0F).setResistance(10.0F);
...
//	public static final Block sign_deco_radiation_warning = new BlockDecoSign("sign_deco_radiation_warning", 1.5F, 10.0F).setCreativeTab(MainRegistry.blockTab);
	...
	public static final Block det_miner2 = new DetMiner2(Material.IRON, "det_miner2").setCreativeTab(MainRegistry.nukeTab).setHardness(0.1F).setResistance(0.0F);
	public static final Block det_miner3 = new DetMiner3(Material.IRON, "det_miner3").setCreativeTab(MainRegistry.nukeTab).setHardness(0.1F).setResistance(0.0F);
	public static final Block det_miner4 = new DetMiner4(Material.IRON, "det_miner4").setCreativeTab(MainRegistry.nukeTab).setHardness(0.1F).setResistance(0.0F);
	...
	public static final Block yellow_barrel = new YellowBarrel(Material.IRON, "yellow_barrel").addRadiation(450.0F).toBlock().setCreativeTab(MainRegistry.nukeTab).setHardness(0.5F).setResistance(2.5F);
	public static final Block vitrified_barrel = new YellowBarrel(Material.IRON, "vitrified_barrel").addRadiation(225.0F).toBlock().setCreativeTab(MainRegistry.nukeTab).setHardness(0.5F).setResistance(2.5F);
	...
	public static final Block qe_sliding_door = new BlockDoorGeneric(Material.IRON, DoorDecl.QE_SLIDING, true, "qe_sliding").setHardness(100.0F).setResistance(1000.0F).setCreativeTab(MainRegistry.machineTab);
	...
	public static final Block rbmk_rod = new RBMKRod(false, false, "rbmk_rod", "rbmk_element").setHardness(15.0F).setResistance(100.0F).setCreativeTab(MainRegistry.machineTab);
	public static final Block rbmk_rod_mod = new RBMKRod(true, false, "rbmk_rod_mod", "rbmk_element_mod").setHardness(15.0F).setResistance(100.0F).setCreativeTab(MainRegistry.machineTab);
	public static final Block rbmk_rod_heatproof = new RBMKRod(false, true, "rbmk_rod_heatproof", "rbmk_element_heatproof").setHardness(15.0F).setResistance(100.0F).setCreativeTab(MainRegistry.machineTab);
	public static final Block rbmk_rod_mod_heatproof = new RBMKRod(true, true, "rbmk_rod_mod_heatproof", "rbmk_element_mod_heatproof").setHardness(15.0F).setResistance(100.0F).setCreativeTab(MainRegistry.machineTab);
	public static final Block rbmk_rod_reasim = new RBMKRodReaSim(false, false, "rbmk_rod_reasim", "rbmk_element_reasim").setHardness(15.0F).setResistance(100.0F).setCreativeTab(MainRegistry.machineTab);
	public static final Block rbmk_rod_reasim_mod = new RBMKRodReaSim(true, false, "rbmk_rod_reasim_mod", "rbmk_element_reasim_mod").setHardness(5.0F).setResistance(100.0F).setCreativeTab(MainRegistry.machineTab);
	...
	public static final Block machine_shreddermk2 = new MachineShreddermk2(Material.IRON, "machine_shreddermk2").setHardness(5.0F).setResistance(10.0F).setCreativeTab(MainRegistry.machineTab);
	public static final int guiID_machine_shreddermk2 = 136;
	...
	public static final Block machine_waste_drum_t2 = new WasteDrumt2(Material.IRON, "machine_waste_drum_t2").setHardness(10.0F).setResistance(100.0F).setCreativeTab(MainRegistry.machineTab);
	public static final int guiID_waste_drum_t2 = 137;
	...
	public static final Block machine_hydrotreater = new MachineHydrotreater(Material.IRON, "machine_hydrotreater").setHardness(5.0F).setResistance(100.0F).setCreativeTab(MainRegistry.machineTab);
	public static final int guiID_machine_hydrotreater = 140;

	public static final Block machine_catalytic_reformer = new MachineCatalyticReformer(Material.IRON, "machine_catalytic_reformer").setHardness(5.0F).setResistance(100.0F).setCreativeTab(MainRegistry.machineTab);
	public static final int guiID_machine_catalytic_reformer = 141;

	public static final Block machine_pyrooven = new MachinePyroOven(Material.IRON, "machine_pyrooven").setHardness(5.0F).setResistance(100.0F).setCreativeTab(MainRegistry.machineTab);
	public static final int guiID_machine_pyrooven = 142;

	public static final Block machine_electrolyser = new MachineElectrolyser(Material.IRON, "machine_electrolyser").setHardness(5.0F).setResistance(100.0F).setCreativeTab(MainRegistry.machineTab);
	...
	public static final Block fluid_duct_mk3 = new BlockFluidPipeMk3(Material.IRON, "fluid_duct_mk3").setHardness(15.0F).setResistance(10000.0F).setCreativeTab(MainRegistry.templateTab);
	public static final Block fluid_duct_mk4 = new BlockFluidPipeMk4(Material.IRON, "fluid_duct_mk4").setHardness(25.0F).setResistance(20000.0F).setCreativeTab(MainRegistry.templateTab);
	...
	public static final Block fluid_duct_mk3_solid = new BlockFluidPipeMk3Solid(Material.IRON, "fluid_duct_mk3_solid").setHardness(15.0F).setResistance(10000.0F).setCreativeTab(MainRegistry.templateTab);
	public static final Block fluid_duct_mk3_solid_sealed = new BlockFluidPipeMk3SolidRadResistant(Material.IRON, "fluid_duct_mk3_solid_sealed").setHardness(15.0F).setResistance(20000.0F).setCreativeTab(MainRegistry.templateTab);
