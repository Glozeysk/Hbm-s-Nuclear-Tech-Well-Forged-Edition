...
import com.hbm.blocks.network.conveyor.block.*;
import com.hbm.blocks.network.conveyor.block.crane.BlockCraneRouter;
import com.hbm.blocks.network.conveyor.crane.*;
...
//	public static final Block sign_deco_radiation_warning = new BlockDecoSign("sign_deco_radiation_warning", 1.5F, 10.0F).setCreativeTab(MainRegistry.blockTab);
	...
	public static final Block crane_sorter = new CraneSorter(Material.IRON, "crane_sorter").setHardness(3.0F).setResistance(2.0F).setCreativeTab(MainRegistry.machineTab);
	...
	public static final Block crane_router = new BlockCraneRouter(Material.IRON, "crane_router").setHardness(3.0F).setResistance(2.0F).setCreativeTab(MainRegistry.machineTab);
