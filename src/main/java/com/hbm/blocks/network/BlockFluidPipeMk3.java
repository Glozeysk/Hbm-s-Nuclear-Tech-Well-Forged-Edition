...
public class BlockFluidPipeMk3 extends BlockContainer implements ILookOverlay, IToolable {
	...
	@Override public TileEntity createNewTileEntity(World worldIn, int meta) { return new TileEntityFFFluidDuctMk3(); }
