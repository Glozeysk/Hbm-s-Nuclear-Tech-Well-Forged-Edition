...
public class BlockConveyorLift extends BlockConveyorChute {
    ...
    public Vec3d getTravelLocation(World world, int x, int y, int z, Vec3d itemPos, double speed) {
        ...
        Vec3d dest = new Vec3d(
                snap.x - dir.getXOffset() * speed * 3,
                snap.y - dir.getYOffset() * speed * 3,
                snap.z - dir.getZOffset() * speed * 3);
        ...
        Vec3d ret = new Vec3d(
                itemPos.x + motion.x / len * speed * 3,
                itemPos.y + motion.y / len * speed * 3,
                itemPos.z + motion.z / len * speed * 3);
        return ret;
    }
