...
public class BlockStorageCrate extends BlockContainer {
	...
	public int getSlots() {
		if (this == ModBlocks.crate_iron) return 36;
		if (this == ModBlocks.crate_steel) return 54;
		if (this == ModBlocks.crate_tungsten) return 27;
		if (this == ModBlocks.crate_desh) return 104;
		if (this == ModBlocks.safe) return 15;
		return 0;
	}
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess world, BlockPos pos) {
		...
		if (te instanceof TileEntityCrateBase) {
			return state.withProperty(OPEN, ((TileEntityCrateBase) te).getOpenCount() > 0);
		}
		return state;
	}
