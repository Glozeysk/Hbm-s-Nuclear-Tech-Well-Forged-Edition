...
public class ModItems {
	...
	public static final Item reformer_oxygen_injector_durasteel = new ItemFlareCatalyst("reformer_oxygen_injector_durasteel", ItemFlareCatalyst.CatalystType.BARRIER).setCreativeTab(MainRegistry.partsTab);
