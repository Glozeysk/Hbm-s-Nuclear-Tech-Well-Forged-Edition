...
import com.hbm.items.gear.ArmorT45MUR;
...
public class ModItems {
	...
	public static final Item meteorite_sword_machined = new ItemSwordMeteorite(64F, 0, MainRegistry.matMeteorite, "meteorite_sword_machined").addHitAbility(new WeaponAbility.FireAbility(4)).addHitAbility(new WeaponAbility.StunAbility(5)).addHitAbility(new WeaponAbility.BeheaderAbility());
	public static final Item meteorite_sword_treated = new ItemSwordMeteorite(79F, 0, MainRegistry.matMeteorite, "meteorite_sword_treated").addHitAbility(new WeaponAbility.FireAbility(4)).addHitAbility(new WeaponAbility.StunAbility(5)).addHitAbility(new WeaponAbility.BeheaderAbility());
	public static final Item meteorite_sword_etched = new ItemSwordMeteorite(99F, 0, MainRegistry.matMeteorite, "meteorite_sword_etched").addHitAbility(new WeaponAbility.FireAbility(4)).addHitAbility(new WeaponAbility.StunAbility(6)).addHitAbility(new WeaponAbility.BeheaderAbility()).addHitAbility(new WeaponAbility.VampireAbility(2));
	public static final Item meteorite_sword_bred = new ItemSwordMeteorite(124F, 0, MainRegistry.matMeteorite, "meteorite_sword_bred").addHitAbility(new WeaponAbility.FireAbility(4)).addHitAbility(new WeaponAbility.StunAbility(6)).addHitAbility(new WeaponAbility.BeheaderAbility()).addHitAbility(new WeaponAbility.VampireAbility(2.5F)).addHitAbility(new WeaponAbility.RadiationAbility(50));
	public static final Item meteorite_sword_irradiated = new ItemSwordMeteorite(174F, 0, MainRegistry.matMeteorite, "meteorite_sword_irradiated").addHitAbility(new WeaponAbility.FireAbility(5)).addHitAbility(new WeaponAbility.StunAbility(7)).addHitAbility(new WeaponAbility.BeheaderAbility()).addHitAbility(new WeaponAbility.VampireAbility(3)).addHitAbility(new WeaponAbility.RadiationAbility(100));
	public static final Item meteorite_sword_fused = new ItemSwordMeteorite(249F, 0, MainRegistry.matMeteorite, "meteorite_sword_fused").addHitAbility(new WeaponAbility.FireAbility(5)).addHitAbility(new WeaponAbility.StunAbility(7)).addHitAbility(new WeaponAbility.BeheaderAbility()).addHitAbility(new WeaponAbility.VampireAbility(3.5F)).addHitAbility(new WeaponAbility.RadiationAbility(150));
	public static final Item meteorite_sword_baleful = new ItemSwordMeteorite(499F, 0, MainRegistry.matMeteorite, "meteorite_sword_baleful").addHitAbility(new WeaponAbility.FireAbility(5)).addHitAbility(new WeaponAbility.StunAbility(8)).addHitAbility(new WeaponAbility.BeheaderAbility()).addHitAbility(new WeaponAbility.VampireAbility(4)).addHitAbility(new WeaponAbility.RadiationAbility(200)).addHitAbility(new WeaponAbility.PhosphorusAbility(100));
	public static final Item meteorite_sword_warped = new ItemSwordMeteorite(2999F, 0, MainRegistry.matMeteorite, "meteorite_sword_warped").addHitAbility(new WeaponAbility.FireAbility(5)).addHitAbility(new WeaponAbility.StunAbility(8)).addHitAbility(new WeaponAbility.BeheaderAbility()).addHitAbility(new WeaponAbility.VampireAbility(4.5F)).addHitAbility(new WeaponAbility.RadiationAbility(350)).addHitAbility(new WeaponAbility.PhosphorusAbility(150));
	public static final Item meteorite_sword_demonic = new ItemSwordMeteorite(13665F, 0, MainRegistry.matMeteorite, "meteorite_sword_demonic").addHitAbility(new WeaponAbility.FireAbility(5)).addHitAbility(new WeaponAbility.StunAbility(9)).addHitAbility(new WeaponAbility.BeheaderAbility()).addHitAbility(new WeaponAbility.VampireAbility(5)).addHitAbility(new WeaponAbility.RadiationAbility(400)).addHitAbility(new WeaponAbility.PhosphorusAbility(200));
