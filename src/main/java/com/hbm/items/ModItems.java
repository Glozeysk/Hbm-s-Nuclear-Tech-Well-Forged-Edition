...
import com.hbm.items.special.ItemMercuryDrop;
...
public class ModItems {
	...
	public static final Item cable_drum = new ItemCableDrum("cable_drum").setCreativeTab(MainRegistry.consumableTab);
	...
	public static final Item armor_battery_mk4 = new ItemModBattery(5D, "armor_battery_mk4").setMaxStackSize(1).setCreativeTab(MainRegistry.consumableTab);
	...
	public static final Item night_goggles = new ItemModGoggles("night_goggles").setMaxStackSize(1).setCreativeTab(MainRegistry.consumableTab);
	...
	public static final Item part_beryllium = new ItemHazard("part_beryllium").addToxic(5).toItem().setCreativeTab(MainRegistry.controlTab);
	...
	public static final Item chlorine_pinwheel = new ItemFluidContainerInfinite(1, "chlorine_pinwheel").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab);
    ...
    public static final Item security_helmet = new ArmorFSB(MainRegistry.enumArmorMaterialSecurity, 7, EntityEquipmentSlot.HEAD, RefStrings.MODID + ":textures/armor/security_1.png", "security_helmet").setMod(0.65F).setProjectileProtection(0.5F).setProtectionLevel(100F).setHasGlassLayer(true).setMaxStackSize(1);
	...
	public static final Item ajr_alpha_helmet = new ArmorAJRAlpha(MainRegistry.aMatAJR, -1, EntityEquipmentSlot.HEAD, RefStrings.MODID + ":textures/armor/starmetal_1.png", 2500000, 10000, 2000, 25, "ajr_alpha_helmet").setMod(0.25F).setCap(6.0F).setThreshold(4F)
			...
			.addResistance("monoxide", 0F)
			.addResistance("fall", 0);
	public static final Item ajr_b_plate = new ArmorAJRAlpha(MainRegistry.aMatAJR, -1, EntityEquipmentSlot.CHEST, RefStrings.MODID + ":textures/armor/starmetal_1.png", 2500000, 10000, 2000, 25, "ajr_alpha_plate").cloneStats((ArmorFSB) ajr_alpha_helmet);
	public static final Item ajr_b_legs = new ArmorAJRAlpha(MainRegistry.aMatAJR, -1, EntityEquipmentSlot.LEGS, RefStrings.MODID + ":textures/armor/starmetal_2.png", 2500000, 10000, 2000, 25, "ajr_alpha_legs").cloneStats((ArmorFSB) ajr_alpha_helmet);
	public static final Item ajr_b_boots = new ArmorAJRAlpha(MainRegistry.aMatAJR, -1, EntityEquipmentSlot.FEET, RefStrings.MODID + ":textures/armor/starmetal_1.png", 2500000, 10000, 2000, 25, "ajr_alpha_boots").cloneStats((ArmorFSB) ajr_alpha_helmet);
	...
	public static final Item jetpack_glider = new JetpackGlider(MainRegistry.enumArmorMaterialSteel, -1, EntityEquipmentSlot.CHEST, 60000, "jetpack_glider").setMaxStackSize(1).setCreativeTab(MainRegistry.weaponTab);
	...
	public static final Item ingot_beryllium = new ItemHazard("ingot_beryllium").addToxic(3).toItem().setCreativeTab(MainRegistry.partsTab);
	...
	public static final Item ingot_cadmium = new ItemHazard("ingot_cadmium").addToxic(5).toItem().setCreativeTab(MainRegistry.partsTab);
	...
	public static final Item ingot_fullerite = new ItemBase("ingot_fullerite").setCreativeTab(MainRegistry.partsTab);
	...
	public static final Item billet_beryllium = new ItemHazard("billet_beryllium").addToxic(2).toItem().setCreativeTab(MainRegistry.partsTab);
	...
	public static final Item billet_po210be = new ItemHazard(ItemHazard.pobe, "billet_po210be").addToxic(2).toItem().setCreativeTab(MainRegistry.partsTab);
	public static final Item billet_ra226be = new ItemHazard(ItemHazard.rabe, "billet_ra226be").addToxic(2).toItem().setCreativeTab(MainRegistry.partsTab);
	public static final Item billet_pu238be = new ItemHazard(ItemHazard.pube, "billet_pu238be").addToxic(2).toItem().setCreativeTab(MainRegistry.partsTab);
	...
	public static final Item nugget_beryllium = new ItemHazard("nugget_beryllium").addToxic(2).toItem().setCreativeTab(MainRegistry.partsTab);
	public static final Item nugget_cadmium = new ItemHazard("nugget_cadmium").addToxic(4).toItem().setCreativeTab(MainRegistry.partsTab);
	...
	public static final Item nugget_mercury = new ItemMercuryDrop("nugget_mercury").addToxic(2).toItem().setCreativeTab(MainRegistry.partsTab);
	...
	public static final Item powder_beryllium = new ItemHazard("powder_beryllium").addToxic(5).toItem().setCreativeTab(MainRegistry.partsTab);
	...
	public static final Item powder_cadmium = new ItemHazard("powder_cadmium").addToxic(7).toItem().setCreativeTab(MainRegistry.partsTab);
	...
	public static final Item powder_soot = new ItemBase("powder_soot").setCreativeTab(MainRegistry.partsTab);
	public static final Item powder_fullerene = new ItemBase("powder_fullerene").setCreativeTab(MainRegistry.partsTab);
	...
	public static final Item powder_poison = new ItemHazard("powder_poison").addToxic(14).toItem().setCreativeTab(MainRegistry.partsTab);
	...
	public static final Item pile_rod_source = new ItemPileRod(3 * ItemHazard.rabe, "pile_rod_source").addToxic(2).toItem().setCreativeTab(MainRegistry.controlTab);
	...
	public static final Item oil_tar_chlorine = new ItemBase("oil_tar_chlorine").setCreativeTab(MainRegistry.partsTab);
	...
	public static final Item lignite = new ItemFuelHazard("lignite", 1200, false).toItem().setCreativeTab(MainRegistry.partsTab);
	...
	public static final Item strange_parmezan = new ItemLemon(200, 200, false, "strange_parmezan").setCreativeTab(MainRegistry.consumableTab);
	...
	public static final Item alloy_hammer = new ItemToolAbility(6F, -2.8F, 0, MainRegistry.enumToolMaterialAlloyHammer, EnumToolType.PICKAXE, "alloy_hammer")
			.addBreakAbility(new ToolAbility.RecursionAbility(3))
			.addBreakAbility(new ToolAbility.SilkAbility())
			.addBreakAbility(new ToolAbility.HammerAbility(1));

	public static final Item alloy_excavator = new ItemToolAbility(5F, -2.8F, 0, MainRegistry.enumToolMaterialAlloyExcavator, EnumToolType.SHOVEL, "alloy_excavator")
			.addBreakAbility(new ToolAbility.RecursionAbility(3))
			.addBreakAbility(new ToolAbility.SilkAbility())
			.addBreakAbility(new ToolAbility.HammerAbility(1));

	public static final Item alloy_paxel = new ItemToolAbility(7F, -2.8F, 0, MainRegistry.enumToolMaterialAlloyPaxel, EnumToolType.MINER, "alloy_paxel")
			.addBreakAbility(new ToolAbility.RecursionAbility(3))
			.addBreakAbility(new ToolAbility.SilkAbility())
			.addBreakAbility(new ToolAbility.HammerAbility(1));
	...
	public static final Item mese_pickaxe = new ItemToolAbility(35F, -2.8F, 0, matMese, EnumToolType.MINER, "mese_pickaxe")
			...
			.addHitAbility(new WeaponAbility.StunAbility(10))
			.addHitAbility(new WeaponAbility.PhosphorusAbility(60))
			.addHitAbility(new WeaponAbility.VampireAbility(15F))
			.addHitAbility(new WeaponAbility.BeheaderAbility())
			.setDepthRockBreaker();
	...
	public static final Item schrabidium_pickaxe = new ItemToolAbility(20, -2.8F, 0, MainRegistry.enumToolMaterialSchrabidium, EnumToolType.PICKAXE, "schrabidium_pickaxe")
			...
			.addBreakAbility(new ToolAbility.ShredderAbility())
			.setRarity(EnumRarity.RARE);
	public static final Item schrabidium_paxel = new ItemToolAbility(40, -2.8F, 0, MainRegistry.enumToolMaterialSchrabidiumPaxel, EnumToolType.MINER, "schrabidium_paxel")
			.addBreakAbility(new ToolAbility.HammerAbility(1))
			.addBreakAbility(new ToolAbility.HammerAbility(2))
			.addBreakAbility(new ToolAbility.RecursionAbility(10))
			.addBreakAbility(new ToolAbility.SilkAbility())
	...
	public static final Item meteorite_sword_seared = new ItemSwordMeteorite(14F, 0, MainRegistry.matMeteorite, "meteorite_sword_seared").addHitAbility(new WeaponAbility.FireAbility(3));
	public static final Item meteorite_sword_reforged = new ItemSwordMeteorite(24F, 0, MainRegistry.matMeteorite, "meteorite_sword_reforged").addHitAbility(new WeaponAbility.FireAbility(3));
	public static final Item meteorite_sword_hardened = new ItemSwordMeteorite(34F, 0, MainRegistry.matMeteorite, "meteorite_sword_hardened").addHitAbility(new WeaponAbility.FireAbility(3)).addHitAbility(new WeaponAbility.StunAbility(4));
	public static final Item meteorite_sword_alloyed = new ItemSwordMeteorite(49F, 0, MainRegistry.matMeteorite, "meteorite_sword_alloyed").addHitAbility(new WeaponAbility.FireAbility(4)).addHitAbility(new WeaponAbility.StunAbility(4));
	public static final Item meteorite_sword_machined = new ItemSwordMeteorite(64F, 0, MainRegistry.matMeteorite, "meteorite_sword_machined").addHitAbility(new WeaponAbility.FireAbility(4)).addHitAbility(new WeaponAbility.StunAbility(5));
	public static final Item meteorite_sword_treated = new ItemSwordMeteorite(79F, 0, MainRegistry.matMeteorite, "meteorite_sword_treated").addHitAbility(new WeaponAbility.FireAbility(4)).addHitAbility(new WeaponAbility.StunAbility(5));
	public static final Item meteorite_sword_etched = new ItemSwordMeteorite(99F, 0, MainRegistry.matMeteorite, "meteorite_sword_etched").addHitAbility(new WeaponAbility.FireAbility(4)).addHitAbility(new WeaponAbility.StunAbility(6)).addHitAbility(new WeaponAbility.VampireAbility(2));
	public static final Item meteorite_sword_bred = new ItemSwordMeteorite(124F, 0, MainRegistry.matMeteorite, "meteorite_sword_bred").addHitAbility(new WeaponAbility.FireAbility(4)).addHitAbility(new WeaponAbility.StunAbility(6)).addHitAbility(new WeaponAbility.VampireAbility(2.5F)).addHitAbility(new WeaponAbility.RadiationAbility(50));
	public static final Item meteorite_sword_irradiated = new ItemSwordMeteorite(174F, 0, MainRegistry.matMeteorite, "meteorite_sword_irradiated").addHitAbility(new WeaponAbility.FireAbility(5)).addHitAbility(new WeaponAbility.StunAbility(7)).addHitAbility(new WeaponAbility.VampireAbility(3)).addHitAbility(new WeaponAbility.RadiationAbility(100));
	public static final Item meteorite_sword_fused = new ItemSwordMeteorite(249F, 0, MainRegistry.matMeteorite, "meteorite_sword_fused").addHitAbility(new WeaponAbility.FireAbility(5)).addHitAbility(new WeaponAbility.StunAbility(7)).addHitAbility(new WeaponAbility.VampireAbility(3.5F)).addHitAbility(new WeaponAbility.RadiationAbility(150));
	public static final Item meteorite_sword_baleful = new ItemSwordMeteorite(499F, 0, MainRegistry.matMeteorite, "meteorite_sword_baleful").addHitAbility(new WeaponAbility.FireAbility(5)).addHitAbility(new WeaponAbility.StunAbility(8)).addHitAbility(new WeaponAbility.VampireAbility(4)).addHitAbility(new WeaponAbility.RadiationAbility(200)).addHitAbility(new WeaponAbility.PhosphorusAbility(100));
	public static final Item meteorite_sword_warped = new ItemSwordMeteorite(2999F, 0, MainRegistry.matMeteorite, "meteorite_sword_warped").addHitAbility(new WeaponAbility.FireAbility(5)).addHitAbility(new WeaponAbility.StunAbility(8)).addHitAbility(new WeaponAbility.VampireAbility(4.5F)).addHitAbility(new WeaponAbility.RadiationAbility(350)).addHitAbility(new WeaponAbility.PhosphorusAbility(150));
	public static final Item meteorite_sword_demonic = new ItemSwordMeteorite(13665F, 0, MainRegistry.matMeteorite, "meteorite_sword_demonic").addHitAbility(new WeaponAbility.FireAbility(5)).addHitAbility(new WeaponAbility.StunAbility(9)).addHitAbility(new WeaponAbility.VampireAbility(5)).addHitAbility(new WeaponAbility.RadiationAbility(400)).addHitAbility(new WeaponAbility.PhosphorusAbility(200));
	...
	public static final Item assembly_template = new ItemAssemblyTemplate("assembly_template").setMaxStackSize(1).setCreativeTab(null);
	public static final Item chemistry_template = new ItemChemistryTemplate("chemistry_template").setMaxStackSize(1).setCreativeTab(null);
	...
	public static final Item crystal_quartz = new ItemBase("crystal_quartz").setCreativeTab(MainRegistry.partsTab);
	...
	public static final Item crystal_beryllium = new ItemHazard("crystal_beryllium").addToxic(15).toItem().setCreativeTab(MainRegistry.partsTab);
	...
	public static final ItemRBMKPellet rbmk_pellet_spk = (ItemRBMKPellet) new ItemRBMKPellet(TextFormatting.OBFUSCATED + "WTF is this rod!?", "rbmk_pellet_spk").addRadiation(1000).addDigamma(0.00625F).toItem();
	...
	public static final ItemRBMKRod rbmk_fuel_spk = (ItemRBMKRod) new ItemRBMKRod(rbmk_pellet_spk, "rbmk_fuel_spk")
			.setYield(1000000000D)
			.setStats(100, 1)
			.setFunction(EnumBurnFunc.SQUARE_ROOT)
			.setDepletionFunction(EnumDepleteFunc.STATIC)
			.setXenon(0.0D, 50D)
			.setHeat(0.01D)
			.setDiffusion(0.2D)
			.setMeltingPoint(50000)
			.setNeutronTypes(NType.SLOW, NType.SLOW)
			.setFuelColor(0.4F, 0F, 0.6F)
			.setCherenkovColor(0.6F, 0F, 1F)
			.addRadiation(240000F)
			.addDigamma(0.05F).toItem();
	...
	public static final Item pellet_advanced = new WatzFuel(0F, false, 216000, 100, 1.1F, 0, 0.995F, 0.99F, "pellet_advanced").setCreativeTab(MainRegistry.controlTab).setMaxStackSize(1);
	...
	public static final Item particle_amat_alt = new ItemBase("particle_amat_alt").setCreativeTab(MainRegistry.controlTab).setContainerItem(ModItems.particle_empty);
	public static final Item particle_aschrab_alt = new ItemBase("particle_aschrab_alt").setCreativeTab(MainRegistry.controlTab).setContainerItem(ModItems.particle_empty);
	...
	public static final Item tiny_singularity = new ItemFWatzCore("capsule_sing_tiny", 200000000L, 50, 50, 200, 1600, 2, true).setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(ModItems.capsule_empty);
	public static final Item tiny_singularity_counter_resonant = new ItemFWatzCore("capsule_sing_counter_tiny", 100000000L, 50, 25, 100, 640, 1, true).setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(ModItems.capsule_empty);
	public static final Item tiny_singularity_super_heated = new ItemFWatzCore("capsule_sing_super_tiny", 300000000L, 75, 150, 1600, 800, 3, true).setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(ModItems.capsule_empty);
	public static final Item tiny_black_hole = new ItemFWatzCore("capsule_hole_tiny", 750000000L, 100, 100, 640, 640, 4, true).setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(ModItems.capsule_empty);
	public static final Item tiny_singularity_spark = new ItemFWatzCore("capsule_sing_spark_tiny", 10000000000L, 500, 500, 1280, 320, 5, true).setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab).setContainerItem(ModItems.capsule_empty);
	...
	public static final Item ams_focus_omega = new ItemLens(1000000000L, 19161.69F, 10.0F, "ams_focus_omega").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab);
