...
public class GUICraneInserterAlt extends GuiInfoContainer {
    ...
    private TileEntityCraneInserterAlt inserter;

    public GUICraneInserterAlt(InventoryPlayer invPlayer, TileEntityCraneInserterAlt tedf) {
        super(new ContainerCraneInserterAlt(invPlayer, tedf));
        inserter = tedf;
