...
public class ContainerCraneInserterAlt extends Container {
    protected TileEntityCraneInserterAlt inserter;

    public ContainerCraneInserterAlt(InventoryPlayer invPlayer, TileEntityCraneInserterAlt inserter) {
