...
public class ContainerMachineChemical extends Container {

	private TileEntityMachineChemical nukeBoy;

	private int progress;
	private int maxProgress;
	
	public ContainerMachineChemical(InventoryPlayer invPlayer, TileEntityMachineChemical tedf) {
		progress = 0;
		nukeBoy = tedf;
