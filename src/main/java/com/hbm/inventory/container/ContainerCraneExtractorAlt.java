...
public class ContainerCraneExtractorAlt extends Container  {
    protected TileEntityCraneExtractorAlt extractor;

    public ContainerCraneExtractorAlt(InventoryPlayer invPlayer, TileEntityCraneExtractorAlt extractor) {
