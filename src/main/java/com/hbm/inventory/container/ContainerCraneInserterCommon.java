...
@ChestContainer(rowSize = 7)
public class ContainerCraneInserterCommon extends Container {

    protected final TileEntityCraneInserterBase inserter;

    public ContainerCraneInserterCommon(InventoryPlayer invPlayer, TileEntityCraneInserterBase inserter) {
