...
public class AssemblerRecipes {
	...
	private static void registerDefaults() {
		...
		makeRecipe(new ComparableStack(ModItems.sat_head_laser, 1), new AStack[] { new OreDictStack(STEEL.ingot(), 12), new OreDictStack(W.ingot(), 16), new ComparableStack(ModItems.ingot_fullerite, 6), new OreDictStack(ANY_HARDPLASTIC.ingot(), 16), new ComparableStack(ModItems.board_copper, 24), new ComparableStack(ModItems.circuit_targeting_tier5, 2), new ComparableStack(Items.REDSTONE, 16), new ComparableStack(Items.DIAMOND, 5), new ComparableStack(Blocks.GLASS_PANE, 16), }, 450);
		...
		makeRecipe(new ComparableStack(ModItems.upgrade_overdrive_1, 1), new AStack[] {new ComparableStack(ModItems.upgrade_speed_3, 1), new ComparableStack(ModItems.upgrade_effect_3, 1), new OreDictStack(ANY_HARDPLASTIC.ingot(), 8), new ComparableStack(ModItems.powder_power, 16), new ComparableStack(ModItems.crystal_lithium, 4), new ComparableStack(ModItems.circuit_schrabidium, 1), }, 200);
		makeRecipe(new ComparableStack(ModItems.upgrade_overdrive_2, 1), new AStack[] {new ComparableStack(ModItems.upgrade_overdrive_1, 1), new ComparableStack(ModItems.upgrade_afterburn_1, 1), new ComparableStack(ModItems.upgrade_speed_3, 1), new ComparableStack(ModItems.upgrade_effect_3, 1), new ComparableStack(ModItems.crystal_lithium, 8), new ComparableStack(ModItems.circuit_tantalium, 16), new ComparableStack(ModItems.ingot_fullerite, 4), }, 300);
		makeRecipe(new ComparableStack(ModItems.upgrade_overdrive_3, 1), new AStack[] {new ComparableStack(ModItems.upgrade_overdrive_2, 1), new ComparableStack(ModItems.upgrade_afterburn_1, 1), new ComparableStack(ModItems.upgrade_speed_3, 1), new ComparableStack(ModItems.upgrade_effect_3, 1), new ComparableStack(ModItems.crystal_lithium, 16), new OreDictStack(KEY_CIRCUIT_BISMUTH), new ComparableStack(ModItems.ingot_fullerite, 8), }, 500);
		...
		//copies of the anvil construction recipes
		makeRecipe(new ComparableStack(ModBlocks.heater_firebox, 1), new AStack[] { new ComparableStack(Blocks.FURNACE), new OreDictStack(STEEL.plate(), 8), new OreDictStack(CU.ingot(), 8), }, 200);
		makeRecipe(new ComparableStack(ModBlocks.heater_oven, 1), new AStack[] { new ComparableStack(ModItems.ingot_firebrick, 16), new OreDictStack(STEEL.plate(), 4), new OreDictStack(CU.ingot(), 8), }, 200);
		makeRecipe(new ComparableStack(ModBlocks.heater_oilburner, 1), new AStack[] { new ComparableStack(ModItems.tank_steel, 4), new ComparableStack(ModItems.pipes_steel, 1), new OreDictStack(TI.ingot(), 12), new OreDictStack(CU.ingot(), 8), }, 300);
		makeRecipe(new ComparableStack(ModBlocks.heater_electric, 1), new AStack[] { new OreDictStack(ANY_PLASTIC.ingot(), 4), new OreDictStack(CU.ingot(), 8), new OreDictStack(STEEL.plate(), 8), new ComparableStack(ModItems.coil_tungsten, 8), new ComparableStack(ModItems.circuit_copper, 1), }, 300);
		makeRecipe(new ComparableStack(ModBlocks.heater_heatex, 1), new AStack[] { new OreDictStack(RUBBER.ingot(), 4), new OreDictStack(CU.ingot(), 16), new OreDictStack(STEEL.plate(), 16), new ComparableStack(ModItems.pipes_steel, 1), }, 400);
		makeRecipe(new ComparableStack(ModBlocks.heater_rt, 1), new AStack[] { new ComparableStack(ModItems.rtg_unit, 5), new OreDictStack(OreDictManager.getReflector(), 8), new OreDictStack(CU.ingot(), 16), new OreDictStack(TCALLOY.ingot(), 6), new OreDictStack(STEEL.plate(), 8), }, 600);
		makeRecipe(new ComparableStack(ModBlocks.heat_boiler, 1), new AStack[] { new OreDictStack(STEEL.ingot(), 4), new OreDictStack(CU.plate(), 16), new ComparableStack(ModItems.plate_polymer, 8), }, 200);
		makeRecipe(new ComparableStack(ModBlocks.machine_tower_small, 1), new AStack[] { new ComparableStack(ModBlocks.brick_concrete, 64), new ComparableStack(Blocks.IRON_BARS, 128), new ComparableStack(ModBlocks.machine_condenser, 5), }, 400);
		makeRecipe(new ComparableStack(ModBlocks.machine_tower_large, 1), new AStack[] { new ComparableStack(ModBlocks.concrete_smooth, 128), new ComparableStack(ModBlocks.steel_scaffold, 32), new ComparableStack(ModBlocks.machine_condenser, 25), new ComparableStack(ModItems.pipes_steel, 2), }, 600);
		makeRecipe(new ComparableStack(ModBlocks.red_pylon_large, 1), new AStack[] { new OreDictStack(ANY_CONCRETE.any(), 2), new ComparableStack(ModBlocks.steel_scaffold, 8), new ComparableStack(ModItems.plate_polymer, 8), new ComparableStack(ModItems.coil_copper, 4), }, 600);
		makeRecipe(new ComparableStack(ModBlocks.substation, 1), new AStack[] { new OreDictStack(ANY_CONCRETE.any(), 6), new OreDictStack(STEEL.ingot(), 4), new ComparableStack(ModBlocks.steel_scaffold, 2), new ComparableStack(ModItems.plate_polymer, 8), new ComparableStack(ModItems.coil_copper, 2), new ComparableStack(ModItems.coil_copper_torus, 2), }, 600);
		makeRecipe(new ComparableStack(ModBlocks.machine_deuterium_extractor, 1), new AStack[] { new OreDictStack(S.dust(), 8), new OreDictStack(STEEL.plate(), 4), new OreDictStack(AL.plate(), 2), new ComparableStack(ModItems.hull_small_steel, 4), new ComparableStack(ModItems.board_copper, 1), new ComparableStack(ModItems.turbine_titanium, 1), new ComparableStack(ModItems.circuit_aluminium, 1), }, 300);
		makeRecipe(new ComparableStack(ModBlocks.machine_deuterium_tower, 1), new AStack[] { new ComparableStack(ModItems.deuterium_filter, 2), new ComparableStack(ModItems.hull_big_steel, 5), new ComparableStack(ModBlocks.concrete_smooth, 8), new ComparableStack(ModBlocks.concrete_asbestos, 4), new ComparableStack(ModBlocks.steel_scaffold, 16), new ComparableStack(ModBlocks.deco_pipe_quad, 12), new OreDictStack(S.dust(), 32), }, 600);
		//machines ported from CE
		makeRecipe(new ComparableStack(ModBlocks.machine_electrolyser, 1), new AStack[] { new OreDictStack(STEEL.plate(), 8), new OreDictStack(CU.plate(), 16), new ComparableStack(ModItems.hull_big_titanium, 3), new OreDictStack(RUBBER.ingot(), 8), new ComparableStack(ModItems.ingot_firebrick, 16), new ComparableStack(ModItems.coil_advanced_alloy, 16), new ComparableStack(ModItems.circuit_copper, 8), }, 400);
		makeRecipe(new ComparableStack(ModBlocks.machine_pyrooven, 1), new AStack[] { new OreDictStack(STEEL.plate(), 16), new OreDictStack(ANY_HARDPLASTIC.ingot(), 16), new ComparableStack(ModItems.ingot_fullerite, 4), new OreDictStack(CU.plate(), 12), new ComparableStack(ModItems.motor_desh, 1), new OreDictStack(KEY_CIRCUIT_BISMUTH, 1), }, 1200);
		makeRecipe(new ComparableStack(ModBlocks.machine_hydrotreater, 1), new AStack[] { new OreDictStack(STEEL.plate(), 8), new OreDictStack(CU.plate(), 4), new OreDictStack(NB.ingot(), 8), new OreDictStack(ANY_RESISTANTALLOY.ingot(), 4), new ComparableStack(ModItems.hull_big_steel, 2), new ComparableStack(ModItems.hull_small_steel, 8), new ComparableStack(ModItems.motor_desh, 2), new ComparableStack(ModItems.circuit_gold, 2), }, 900);
		makeRecipe(new ComparableStack(ModBlocks.machine_catalytic_reformer, 1), new AStack[] { new OreDictStack(STEEL.plate(), 12), new OreDictStack(CU.plate(), 8), new OreDictStack(NB.ingot(), 8), new OreDictStack(ANY_RESISTANTALLOY.ingot(), 4), new ComparableStack(ModItems.hull_big_steel, 3), new ComparableStack(ModItems.hull_small_steel, 8), new ComparableStack(ModItems.motor, 2), new ComparableStack(ModItems.circuit_gold, 2), }, 900);
		makeRecipe(new ComparableStack(ModBlocks.machine_pump_ocean, 1), new AStack[] { new OreDictStack(STEEL.block(), 8), new OreDictStack(STEEL.plate(), 16), new OreDictStack(PB.plate(), 4), new ComparableStack(ModItems.motor_desh, 2), new ComparableStack(ModItems.coil_tungsten, 4), new ComparableStack(ModItems.circuit_red_copper, 2), }, 300);
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_saturnite_battery, 1), new AStack[] { 
			...
			new NbtComparableStack(ItemFluidTank.getFullBarrel(ModForgeFluids.sodiumbase, 1)),
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_radspice_battery, 1), new AStack[] { 
			...
			new ComparableStack(ModItems.ingot_fullerite, 16), }, 3200);
		makeRecipe(new ComparableStack(ModBlocks.machine_dineutronium_battery, 1), new AStack[] { 
			...
			new ComparableStack(ModItems.ingot_fullerite, 32),
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_electronium_battery, 1), new AStack[] { 
			...
			new OreDictStack(OSMIRIDIUM.dust(), 32), 
			new ComparableStack(ModItems.battery_spark_cell_10000, 1), 
			new ComparableStack(ModItems.ingot_fullerite, 64),
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_shreddermk2, 1), new AStack[] {
				new ComparableStack(ModBlocks.machine_shredder, 1),
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_waste_drum_t2, 1), new AStack[] {
				new ComparableStack(ModBlocks.machine_waste_drum, 1),
				new ComparableStack(ModItems.ingot_starmetal, 12),
				new ComparableStack(ModItems.plate_desh, 4),
				new ComparableStack(ModBlocks.block_niter_reinforced, 4),
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_chemical, 1), new AStack[] { new OreDictStack(STEEL.ingot(), 8), new OreDictStack(CU.plate(), 4), new ComparableStack(ModItems.plate_polymer, 16), new ComparableStack(ModItems.motor, 2), new ComparableStack(ModItems.coil_tungsten, 2), new ComparableStack(ModItems.circuit_copper, 2), }, 200);
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_schrabidium_transmutator, 1), new AStack[] { new ComparableStack(ModBlocks.fwatz_conductor, 4), new OreDictStack(ANY_RESISTANTALLOY.ingot(), 24), new ComparableStack(ModItems.plate_saturnite, 18), new OreDictStack(STEEL.plate(), 12), new ComparableStack(ModItems.plate_desh, 6), new OreDictStack(ANY_HARDPLASTIC.ingot(), 8), new ComparableStack(ModBlocks.machine_saturnite_battery, 5), new OreDictStack(KEY_CIRCUIT_BISMUTH, 2), }, 600);
		makeRecipe(new ComparableStack(ModBlocks.machine_combine_factory, 1), new AStack[] { new OreDictStack(STEEL.plate(), 8), new OreDictStack(ANY_HARDPLASTIC.ingot(), 8), new ComparableStack(ModItems.ingot_fullerite, 4), new ComparableStack(ModItems.board_copper, 8), new OreDictStack(KEY_CIRCUIT_BISMUTH, 4), new ComparableStack(ModItems.coil_magnetized_tungsten, 8), new ComparableStack(ModItems.coil_tungsten, 16), new ComparableStack(ModBlocks.fwatz_conductor, 12), }, 600);
		...
		makeRecipe(new ComparableStack(ModBlocks.fusion_center, 1), new AStack[] { new OreDictStack(W.ingot(), 4), new OreDictStack(STEEL.plate(), 6), new ComparableStack(ModItems.wire_advanced_alloy, 24), new OreDictStack(ANY_HARDPLASTIC.ingot(), 4), }, 200);
		makeRecipe(new ComparableStack(ModBlocks.fusion_motor, 1), new AStack[] { new OreDictStack(TI.ingot(), 4), new OreDictStack(STEEL.ingot(), 2), new ComparableStack(ModItems.motor, 4), new OreDictStack(ANY_HARDPLASTIC.ingot(), 4), }, 250);
		...
		makeRecipe(new ComparableStack(ModBlocks.watz_element, 1), new AStack[] { new OreDictStack(W.ingot(), 4), new OreDictStack(ANY_HARDPLASTIC.ingot(), 4), new ComparableStack(ModItems.rod_empty, 2), new ComparableStack(ModItems.wire_magnetized_tungsten, 2), new ComparableStack(ModItems.wire_advanced_alloy, 4), }, 200);
		...
		makeRecipe(new ComparableStack(ModBlocks.fwatz_computer, 1), new AStack[] { new ComparableStack(ModBlocks.block_meteor, 3), new ComparableStack(ModItems.wire_magnetized_tungsten, 48), new OreDictStack(SBD.dust(), 12), new ComparableStack(ModItems.circuit_schrabidium, 12), }, 300);
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_fensu, 1), new AStack[] { new ComparableStack(ModItems.ingot_electronium, 32), new ComparableStack(ModBlocks.machine_electronium_battery, 8), new ComparableStack(ModBlocks.block_dura_steel, 16), new OreDictStack(STAR.block(), 64), new ComparableStack(ModBlocks.machine_transformer_dnt, 8), new ComparableStack(ModItems.coil_magnetized_tungsten, 24), new ComparableStack(ModItems.powder_magic, 64), new ComparableStack(ModItems.plate_dineutronium, 24), new ComparableStack(ModItems.ingot_u238m2), new OreDictStack(ANY_HARDPLASTIC.ingot(), 64), new ComparableStack(ModItems.ingot_radspice, 64), new ComparableStack(ModItems.ingot_fullerite, 64) }, 1200);
		makeRecipe(new ComparableStack(ModBlocks.struct_iter_core, 1), new AStack[] {
				new OreDictStack(STEEL.ingot(), 6),
				new ComparableStack(ModItems.ingot_fullerite, 4),
		...
		makeRecipe(new ComparableStack(ModItems.pellet_mercury, 2), new AStack[] { new OreDictStack(PB.nugget(), 12), }, new FluidStack[]{new FluidStack(ModForgeFluids.mercury, 125)} ,50);
		...
		makeRecipe(new ComparableStack(ModBlocks.rbmk_rod_heatproof, 1), new AStack[] {
				new ComparableStack(ModBlocks.concrete_asbestos, 4),
				new OreDictStack(W.block(), 4),
