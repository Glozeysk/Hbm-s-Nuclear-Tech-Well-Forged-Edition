...
public class AssemblerRecipes {
	...
	private static void registerDefaults() {
		...
		makeRecipe(new ComparableStack(ModItems.reformer_oxygen_injector_durasteel, 1), new AStack[] {new ComparableStack(ModItems.bolt_dura_steel, 16), new ComparableStack(ModItems.circuit_copper, 1), new ComparableStack(ModItems.motor, 2), new ComparableStack(ModItems.piston_pneumatic, 4), new ComparableStack(ModItems.plate_advanced_alloy, 8), new ComparableStack(ModItems.wire_copper, 8)}, 200);
		makeRecipe(new ComparableStack(ModBlocks.machine_flare, 1), new AStack[] { new ComparableStack(ModBlocks.steel_scaffold, 28), new ComparableStack(ModItems.tank_steel, 2), new ComparableStack(ModItems.pipes_steel, 2), new ComparableStack(ModItems.hull_small_steel, 2), new ComparableStack(ModItems.thermo_element, 3),  new ComparableStack(ModItems.ingot_firebrick , 32 	)}, 200);
