...
public class AssemblerRecipes {
	...
	private static void registerDefaults() {
		...
		makeRecipe(new ComparableStack(ModBlocks.conveyor_double, 4), new AStack[]{new ComparableStack(ModBlocks.conveyor, 8), new OreDictStack(IRON.plate(), 4)}, 80);
		makeRecipe(new ComparableStack(ModBlocks.conveyor_double_express, 4), new AStack[]{new ComparableStack(ModBlocks.conveyor_express, 8), new OreDictStack(STEEL.plate(), 4)}, 80);
