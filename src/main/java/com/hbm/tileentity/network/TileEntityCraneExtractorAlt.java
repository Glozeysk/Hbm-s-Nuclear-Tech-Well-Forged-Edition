...
import com.hbm.inventory.gui.GUICraneExtractorAlt;
...
public class TileEntityCraneExtractorAlt extends TileEntityCraneBase implements IGUIProvider, IControlReceiver, IBufPacketReceiver {
    ...
    public TileEntityCraneExtractorAlt() {
        super(20);
    ...
    public String getName() {
        return "container.craneExtractorAlt";
    }
    ...
    public Container provideContainer(int ID, EntityPlayer player, World world, int x, int y, int z) {
        ...
        return new ContainerCraneExtractorAlt(player.inventory, this);
    }

    @Override
    @SideOnly(Side.CLIENT)
    public GuiScreen provideGUI(int ID, EntityPlayer player, World world, int x, int y, int z) {
        return new GUICraneExtractorAlt(player.inventory, this);
    }
