...
import com.hbm.inventory.container.ContainerCraneInserterAlt;
import com.hbm.inventory.gui.GUICraneInserterAlt;
...
public class TileEntityCraneInserterAlt extends TileEntityCraneBase implements IGUIProvider {

    public TileEntityCraneInserterAlt() {
        super(21);
    }
    ...
    public Container provideContainer(int ID, EntityPlayer player, World world, int x, int y, int z) {
        return new ContainerCraneInserterAlt(player.inventory, this);
    }

    @Override
    @SideOnly(Side.CLIENT)
    public GuiScreen provideGUI(int ID, EntityPlayer player, World world, int x, int y, int z) {
        return new GUICraneInserterAlt(player.inventory, this);
    }
