...
public abstract class TileEntityPylonBase extends TileEntityCableBaseNT {
    ...
    public int cableColorR = 216;
    public int cableColorG = 64;
    public int cableColorB = 10;
    ...
    public void setCableColor(int r, int g, int b) {
        this.cableColorR = r;
        this.cableColorG = g;
        this.cableColorB = b;
        this.markDirty();
    ...
    public NBTTagCompound writeToNBT(NBTTagCompound nbt) {
        ...
        nbt.setInteger("cableColorR", cableColorR);
        nbt.setInteger("cableColorG", cableColorG);
        nbt.setInteger("cableColorB", cableColorB);
    ...
    public void readFromNBT(NBTTagCompound nbt) {
        ...
        if (nbt.hasKey("cableColorR")) {
            this.cableColorR = nbt.getInteger("cableColorR");
            this.cableColorG = nbt.getInteger("cableColorG");
            this.cableColorB = nbt.getInteger("cableColorB");
        }
    }
