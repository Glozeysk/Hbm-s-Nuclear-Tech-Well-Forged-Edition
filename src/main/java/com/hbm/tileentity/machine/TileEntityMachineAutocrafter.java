...
public class TileEntityMachineAutocrafter extends TileEntityMachineBase implements IEnergyUser, ITickable, IGUIProvider {
    ...
    public boolean isItemValidForSlot(int slot, ItemStack stack) {
        ...
        for(Integer i : validSlots) {
            ...
            if(!(valid.isItemEqual(stack) && ItemStack.areItemStackTagsEqual(valid, stack))) continue;
    ...
    private boolean isValidForFilter(ItemStack filter, String mode, ItemStack input) {
        ...
        switch(mode) {
            case MODE_EXACT:
                return input.isItemEqual(filter) && ItemStack.areItemStackTagsEqual(input, filter);
            case MODE_WILDCARD:
                return input.getItem() == filter.getItem() && ItemStack.areItemStackTagsEqual(input, filter);
            default:
    ...
    public static class InventoryCraftingAuto extends InventoryCrafting {
        ...
        public InventoryCraftingAuto(int width, int height) {
            super(new ContainerBlank(), width, height);
        }
