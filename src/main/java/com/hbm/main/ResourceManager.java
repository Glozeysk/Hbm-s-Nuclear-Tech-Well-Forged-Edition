...
public class ResourceManager {
	...
	public static final IModelCustom pipe_neo_mk4 = new HFRWavefrontObject(new ResourceLocation(RefStrings.MODID, "models/blocks/pipe_neo_mk4.obj")).asVBO();
	...
	public static final ResourceLocation ajr_mur_chest = new ResourceLocation(RefStrings.MODID, "textures/armor/ajr_mur_chest.png");
	public static final ResourceLocation ajr_mur_arm = new ResourceLocation(RefStrings.MODID, "textures/armor/ajr_mur_arm.png");
