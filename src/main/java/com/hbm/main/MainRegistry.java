...
public class MainRegistry {
	...
	private static SoundEvent getArmorEquipSound() {
		SoundEvent soundEvent = SoundEvent.REGISTRY.getObject(new ResourceLocation("minecraft", "item.armor.equip_generic"));
		if(soundEvent != null) {
			return soundEvent;
		}

		soundEvent = SoundEvent.REGISTRY.getObject(new ResourceLocation("minecraft", "item.armor.equip_iron"));
		if(soundEvent != null) {
			return soundEvent;
		}
	...
	// end are.
	public static ArmorMaterial enumArmorMaterialT45 = EnumHelper.addArmorMaterial(RefStrings.MODID + ":T45", RefStrings.MODID + ":T45", 150, new int[] { 3, 6, 8, 3 }, 0, getArmorEquipSound(), 2.0F);
	public static ArmorMaterial enumArmorMaterialT45Mur = EnumHelper.addArmorMaterial(RefStrings.MODID + ":T45MUR", RefStrings.MODID + ":T45MUR", 150, new int[] { 3, 6, 8, 3 }, 0, getArmorEquipSound(), 2.0F);
	public static ArmorMaterial enumArmorMaterialT51 = EnumHelper.addArmorMaterial(RefStrings.MODID + ":T51", RefStrings.MODID + ":T51", 150, new int[] { 3, 6, 8, 3 }, 0, getArmorEquipSound(), 2.0F);
	public static ArmorMaterial aMatBJ = EnumHelper.addArmorMaterial(RefStrings.MODID + ":BLACKJACK", RefStrings.MODID + ":HBM_BLACKJACK", 150, new int[] { 3, 6, 8, 3 }, 100, getArmorEquipSound(), 2.0F);
	public static ArmorMaterial aMatAJR = EnumHelper.addArmorMaterial(RefStrings.MODID + ":T45AJR", RefStrings.MODID + ":T45AJR", 150, new int[] { 3, 6, 8, 3 }, 100, getArmorEquipSound(), 2.0F);
	public static ArmorMaterial aMatAJRMur = EnumHelper.addArmorMaterial(RefStrings.MODID + ":T45AJRMUR", RefStrings.MODID + ":T45AJRMUR", 150, new int[] { 3, 6, 8, 3 }, 100, getArmorEquipSound(), 2.0F);

	public static ArmorMaterial aMatRPA = EnumHelper.addArmorMaterial(RefStrings.MODID + ":RPA", RefStrings.MODID + ":RPA", 150, new int[] { 3, 6, 8, 3 }, 100, getArmorEquipSound(), 2.0F);
	public static ArmorMaterial aMatHEV = EnumHelper.addArmorMaterial(RefStrings.MODID + ":HEV", RefStrings.MODID + ":HEV", 150, new int[] { 3, 6, 8, 3 }, 100, getArmorEquipSound(), 2.0F);
	public static ArmorMaterial enumArmorMaterialHazmat = EnumHelper.addArmorMaterial(RefStrings.MODID + ":HAZMAT", RefStrings.MODID + ":HAZMAT", 60, new int[] { 1, 4, 5, 2 }, 5, getArmorEquipSound(), 0.0F);
	public static ArmorMaterial enumArmorMaterialHazmat2 = EnumHelper.addArmorMaterial(RefStrings.MODID + ":HAZMAT2", RefStrings.MODID + ":HAZMAT2", 60, new int[] { 1, 4, 5, 2 }, 5, getArmorEquipSound(), 0.0F);
	public static ArmorMaterial enumArmorMaterialHazmat3 = EnumHelper.addArmorMaterial(RefStrings.MODID + ":HAZMAT3", RefStrings.MODID + ":HAZMAT3", 60, new int[] { 1, 4, 5, 2 }, 5, getArmorEquipSound(), 0.0F);
	public static ArmorMaterial enumArmorMaterialPaa = EnumHelper.addArmorMaterial(RefStrings.MODID + ":PAA", RefStrings.MODID + ":PAA", 75, new int[] { 3, 6, 8, 3 }, 25, getArmorEquipSound(), 2.0F);
	public static ArmorMaterial enumArmorMaterialSchrabidium = EnumHelper.addArmorMaterial(RefStrings.MODID + ":SCHRABIDIUM", RefStrings.MODID + ":SCHRABIDIUM", 100, new int[] { 3, 6, 8, 3 }, 50, getArmorEquipSound(), 2.0F);
	public static ArmorMaterial enumArmorMaterialEuphemium = EnumHelper.addArmorMaterial(RefStrings.MODID + ":EUPHEMIUM", RefStrings.MODID + ":EUPHEMIUM", 15000000, new int[] { 3, 6, 8, 3 }, 100, getArmorEquipSound(), 2.0F);
	public static ArmorMaterial enumArmorMaterialSteel = EnumHelper.addArmorMaterial(RefStrings.MODID + ":STEEL", RefStrings.MODID + ":STEEL", 20, new int[] { 2, 5, 6, 2 }, 5, getArmorEquipSound(), 0.0F);
	public static ArmorMaterial enumArmorMaterialAlloy = EnumHelper.addArmorMaterial(RefStrings.MODID + ":ALLOY", RefStrings.MODID + ":ALLOY", 40, new int[] { 3, 6, 8, 3 }, 12, getArmorEquipSound(), 0.0F);
	public static ArmorMaterial enumArmorMaterialAusIII = EnumHelper.addArmorMaterial(RefStrings.MODID + ":AUSIII", RefStrings.MODID + ":AUSIII", 375, new int[] {2, 5, 6, 2}, 0, getArmorEquipSound(), 0.0F);
	public static ArmorMaterial enumArmorMaterialTitanium = EnumHelper.addArmorMaterial(RefStrings.MODID + ":TITANIUM", RefStrings.MODID + ":TITANIUM", 25, new int[] {3, 6, 8, 3}, 9, getArmorEquipSound(), 2.0F);
	public static ArmorMaterial enumArmorMaterialCmb = EnumHelper.addArmorMaterial(RefStrings.MODID + ":CMB", RefStrings.MODID + ":CMB", 60, new int[] {3, 6, 8, 3}, 50, getArmorEquipSound(), 2.0F);
	public static ArmorMaterial enumArmorMaterialSecurity = EnumHelper.addArmorMaterial(RefStrings.MODID + ":SECURITY", RefStrings.MODID + ":SECURITY", 100, new int[] {3, 6, 8, 3}, 15, getArmorEquipSound(), 2.0F);
	public static ArmorMaterial enumArmorMaterialAsbestos = EnumHelper.addArmorMaterial(RefStrings.MODID + ":ASBESTOS", RefStrings.MODID + ":ASBESTOS", 20, new int[] {1, 3, 4, 1}, 5, getArmorEquipSound(), 0.0F);
	public static ArmorMaterial aMatCobalt = EnumHelper.addArmorMaterial(RefStrings.MODID + ":COBALT", RefStrings.MODID + ":COBALT", 70, new int[] {3, 6, 8, 3}, 25, getArmorEquipSound(), 2.0F);
	public static ArmorMaterial aMatStarmetal = EnumHelper.addArmorMaterial(RefStrings.MODID + ":STARMETAL", RefStrings.MODID + ":STARMETAL", 150, new int[] {3, 6, 8, 3}, 100, getArmorEquipSound(), 2.0F);
	public static ArmorMaterial aMatLiquidator = EnumHelper.addArmorMaterial(RefStrings.MODID + ":LIQUIDATOR", RefStrings.MODID + ":LIQUIDATOR", 750, new int[] { 3, 6, 8, 3 }, 10, getArmorEquipSound(), 2.0F);
	public static ArmorMaterial aMatFau = EnumHelper.addArmorMaterial(RefStrings.MODID + ":DIGAMMA", RefStrings.MODID + ":DIGAMMA", 150, new int[] { 3, 8, 6, 3 }, 100, getArmorEquipSound(), 2.0F);
	public static ArmorMaterial aMatDNS = EnumHelper.addArmorMaterial(RefStrings.MODID + ":DNT_NANO", RefStrings.MODID + ":DNT_NANO", 150, new int[] { 3, 8, 6, 3 }, 100, getArmorEquipSound(), 2.0F);
	...
	@EventHandler
	public void construct(net.minecraftforge.fml.common.event.FMLConstructionEvent event) {
		proxy.construct();
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		reg(TileEntityDummy.class, "tileentity_dummy");
		reg(TileEntityMachineAssembler.class, "tileentity_machine_assembler");
		reg(TileEntityMachineAssembly.class, "tileentity_machine_assembly");
		reg(TileEntityDiFurnace.class, "tileentity_machine_difurnace");
		reg(TileEntityDiFurnaceRTG.class, "tileentity_machine_difurnace_rtg");
		reg(TileEntityMachineDiFurnaceBig.class, "tileentity_machine_difurnace_big");
		reg(TileEntityMachinePress.class, "tileentity_machine_press");
		reg(TileEntityTestRender.class, "tileentity_testrenderer");
		reg(TileEntityMachineChemplant.class, "tileentity_machine_chemplant");
		reg(TileEntityMachineChemical.class, "tileentity_machine_chemical");
		reg(TileEntityMachineChemfac.class, "tileentity_machine_chemfac");
		reg(TileEntityMachineMixer.class, "tileentity_machine_mixer");
		reg(TileEntityDummyPort.class, "tileentity_dummy_port");
		reg(TileEntityDummyPortNew.class, "tileentity_dummy_portnew");
		reg(TileEntityNukeMan.class, "tileentity_nuke_man");
		reg(TileEntityNukeFleija.class, "tileentity_nuke_fleija");
		reg(TileEntityMachineCoal.class, "tileentity_machine_coal");
		reg(TileEntityMachineGenerator.class, "tileentity_machine_generator");
		reg(TileEntityMachineReactorSmall.class, "tileentity_machine_reactor_small");
		reg(TileEntityMachineRTG.class, "tileentity_machine_rtg_grey");
		reg(TileEntityCableBaseNT.class, "tileentity_cable");
		reg(TileEntityDiode.class, "tileentity_cable_diode");
		reg(TileEntityCableGauge.class, "tileentity_cable_gauge");
		reg(TileEntityBedrockOre.class, "tileentity_ore_bedrock");
		reg(TileEntityMachineBattery.class, "tileentity_machine_battery");
		reg(TileEntityMachineTransformer.class, "tileentity_machine_transformer");
		reg(TileEntityConverterHeRf.class, "tileentity_converter_he_rf");
		reg(TileEntityConverterRfHe.class, "tileentity_converter_rf_he");
		reg(TileEntityMachineTurbine.class, "tileentity_machine_turbine");
		reg(TileEntityTurretSpitfire.class, "tileentity_turret_spitfire");
		reg(TileEntityTurretCIWS.class, "tileentity_turret_ciws");
		reg(TileEntityTurretCheapo.class, "tileentity_turret_cheapo");
		reg(TileEntityTurretRocket.class, "tileentity_turret_rocket");
		reg(TileEntityTurretLight.class, "tileentity_turret_light");
		reg(TileEntityTurretHeavy.class, "tileentity_turret_heavy");
		reg(TileEntityTurretFlamer.class, "tileentity_turret_flamer");
		reg(TileEntityDecoBlock.class, "tileentity_deco_block");
		reg(TileEntityLaunchPad.class, "tileentity_launch_pad");
		reg(TileEntityMachineBoiler.class, "tileentity_machine_boiler");
		reg(TileEntityHeatBoiler.class, "tileentity_heat_boiler");
		reg(TileEntityMachineBoilerElectric.class, "tileentity_machine_boiler_electric");
		reg(TileEntityMachineBoilerRTG.class, "tileentity_machine_boiler_rtg");
		reg(TileEntityMachineEPress.class, "tileentity_machine_epress");
		reg(TileEntityConnector.class, "tileentity_connector_red_wire");
		reg(TileEntityPylon.class, "tileentity_pylon_red_wire");
		reg(TileEntityPylonLarge.class, "tileentity_pylon_large");
		reg(TileEntitySubstation.class, "tileentity_pylon_substation");
		reg(TileEntityMachineCentrifuge.class, "tileentity_machine_centrifuge");
		reg(TileEntityMachineGasCent.class, "tileentity_machine_gascent");
		reg(TileEntityMachineUF6Tank.class, "tileentity_machine_uf6_tank");
		reg(TileEntityMachinePuF6Tank.class, "tileentity_machine_puf6_tank");
		reg(TileEntityRailgun.class, "tileentity_railgun");
		reg(TileEntityMachineReactor.class, "tileentity_machine_reactor");
		reg(TileEntityMachineShredder.class, "tileentity_machine_shredder");
		reg(TileEntityMachineShreddermk2.class, "tileentity_machine_shreddermk2");
		reg(TileEntityDummyFluidPort.class, "tileentity_dummy_fluid_port");
		reg(TileEntityMachineFluidTank.class, "tileentity_machine_fluidtank");
		reg(TileEntityCableSwitch.class, "tileentity_cable_switch");
		...
		reg(TileEntityBroadcaster.class, "tileentity_machine_broadcaster");
		reg(TileEntityGeiger.class, "tileentity_machine_geiger");
		reg(TileEntityHatch.class, "tileentity_hatch");
		reg(TileEntityVaultDoor.class, "tileentity_vault_door");
		reg(TileEntityBlastDoor.class, "tileentity_blastdoor");
		reg(TileEntityCrateIron.class, "tileentity_crate_iron");
		reg(TileEntityCrateSteel.class, "tileentity_crate_steel");
		reg(TileEntityCrateDesh.class, "tileentity_crate_desh");
		reg(TileEntitySafe.class, "tileentity_safe");
		reg(TileEntityMachineKeyForge.class, "tileentity_machine_key_forge");
		reg(TileEntityNukeFurnace.class, "tileentity_nuke_furnace");
		reg(TileEntityRtgFurnace.class, "tileentity_rtg_furnace");
		reg(TileEntityMachineSeleniumEngine.class, "tileentity_machine_selenium");
		reg(TileEntityReactorControl.class, "tileentity_machine_reactor_control");
		reg(TileEntityMachineRadGen.class, "tileentity_machine_radgen");
		reg(TileEntityRadSensor.class, "tileentity_radsensor");
		reg(TileEntityMachineAmgen.class, "tileentity_machine_amgen");
		reg(TileEntityMachineSPP.class, "tileentity_machine_spp");
		reg(TileEntityMachineArcFurnace.class, "tileentity_machine_arc_furnace");
		reg(TileEntityMachineElectricFurnace.class, "tileentity_machine_electric_furnace");
		reg(TileEntityWasteDrum.class, "tileentity_waste_drum");
		reg(TileEntityWasteDrumt2.class, "tileentity_waste_drum_t2");
		reg(TileEntityMachineOilWell.class, "tileentity_machine_oil_well");
		reg(TileEntityMachinePumpjack.class, "tileentity_machine_pumpjack");
		reg(TileEntityMachineFrackingTower.class, "tileentity_machine_fracking_tower");
		reg(TileEntityMachineCatalyticCracker.class, "tileentity_machine_catalytic_cracker");
		reg(TileEntityMachineGasFlare.class, "tileentity_machine_gas_flare");
		reg(TileEntityMachineExcavator.class, "tileentity_machine_excavator");
		reg(TileEntityMachineTurbofan.class, "tileentity_machine_turbofan");
		reg(TileEntityMachineCMBFactory.class, "tileentity_machine_cmb_factory");
		reg(TileEntityMachineTeleporter.class, "tileentity_machine_teleporter");
		reg(TileEntityRadiobox.class, "tileentity_radiobox");
		reg(TileEntityRadioRec.class, "tileentity_radiorec");
		reg(TileEntityDeconRad.class, "tileentity_deconrad");
		reg(TileEntityDeconDi.class, "tileentity_decondi");
		reg(TileEntityCharger.class, "tileentity_charger");
		reg(TileEntityVent.class, "tileentity_vent");
		reg(TileEntityChlorineSeal.class, "tileentity_chlorine_seal");
		reg(TileEntityStructureMarker.class, "tileentity_structure_marker");
		reg(TileEntityCoreTitanium.class, "tileentity_core_titanium");
		reg(TileEntityCoreAdvanced.class, "tileentity_core_advanced");
		reg(TileEntityReactorHatch.class, "tileentity_reactor_hatch");
		reg(TileEntityFactoryHatch.class, "tileentity_factory_hatch");
		reg(TileEntityMachineReactorLarge.class, "tileentity_reactor_large");
		reg(TileEntityWatzHatch.class, "tileentity_watz_hatch");
		reg(TileEntityWatzCore.class, "tileentity_watz_core");
		reg(TileEntityFWatzHatch.class, "tileentity_fwatz_hatch");
		reg(TileEntityFWatzCore.class, "tileentity_fwatz_core");
		reg(TileEntityNukeGadget.class, "tileentity_nuke_gadget");
		reg(TileEntityNukeBoy.class, "tileentity_nuke_boy");
		reg(TileEntityNukeMike.class, "tileentity_nuke_mike");
		reg(TileEntityNukeTsar.class, "tileentity_nuke_tsar");
		reg(TileEntityNukePrototype.class, "tileentity_nuke_prototype");
		reg(TileEntityNukeSolinium.class, "tileentity_nuke_solinium");
		reg(TileEntityNukeN2.class, "tileentity_nuke_n2");
		reg(TileEntityNukeCustom.class, "tileentity_nuke_custom");
		reg(TileEntityBombMulti.class, "tileentity_bomb_multi");
		reg(TileEntityCrashedBomb.class, "tileentity_crashed_bomb");
		reg(TileEntityLandmine.class, "tileentity_landmine");
		reg(TileEntityMachineTeleLinker.class, "tileentity_telelinker");
		reg(TileEntityMachineMissileAssembly.class, "tileentity_machine_missile_assembly");
		reg(TileEntityCompactLauncher.class, "tileentity_compact_launcher");
		reg(TileEntityMultiblock.class, "tileentity_launcher_multiblock");
		reg(TileEntityLaunchTable.class, "tileentity_launch_table");
		reg(TileEntityAMSEmitter.class, "tileentity_ams_emitter");
		reg(TileEntityAMSLimiter.class, "tileentity_ams_limiter");
		reg(TileEntityAMSBase.class, "tileentity_ams_base");
		reg(TileEntityMachineSatLinker.class, "tileentity_machine_sat_linker");
		reg(TileEntityMachineSatDock.class, "tileentity_machine_sat_dock");
		reg(TileEntityMachineDiesel.class, "tileentity_machine_diesel");
		reg(TileEntityForceField.class, "tileentity_force_field");
		reg(TileEntityMachineRadar.class, "tileentity_machine_radar");
		reg(TileEntityDecoPoleSatelliteReceiver.class, "tileentity_deco_pole_satellite_receiver");
		reg(TileEntityDeuteriumExtractor.class, "tileentity_deuterium_extractor");
		reg(TileEntityDeuteriumTower.class, "tileentity_deuterium_tower");
		reg(TileEntityGeysir.class, "tileentity_geyser");
		reg(TileEntityObjTester.class, "tileentity_obj_tester");

		//Dummy classes to ensure backward compatibility
		reg(TileEntityLegacySuccMk2.class, "tileentity_ff_succ_mk2");
		reg(TileEntityLegacySuccMk2Solid.class, "tileentity_ff_succ_mk2_solid");
		reg(TileEntityLegacySuccMk3.class, "tileentity_ff_succ_mk3");
		reg(TileEntityLegacySuccMk3Solid.class, "tileentity_ff_succ_mk3_solid");
		reg(TileEntityLegacySuccMk4.class, "tileentity_ff_succ_mk4");

		reg(TileEntityDecoBlockAlt.class, "tileentity_deco_block_alt");
		reg(TileEntityFFFluidDuctMk2.class, "tileentity_ff_fludi_duct_mk2");
		reg(TileEntityFFFluidDuctMk3.class, "tileentity_ff_fludi_duct_mk3");
		reg(TileEntityFFFluidDuctMk4.class, "tileentity_ff_fludi_duct_mk4");
		reg(TileEntityFFFluidDuctMk2Solid.class, "tileentity_ff_fludi_duct_mk2_solid");
		reg(TileEntityFFFluidDuctMk3Solid.class, "tileentity_ff_fludi_duct_mk3_solid");
		reg(TileEntityBarrel.class, "tileentity_barrel");
		reg(TileEntityTesla.class, "tileentity_tesla");
		reg(TileEntityCyberCrab.class, "tileentity_cybercrab");
		reg(TileEntityCoreEmitter.class, "tileentity_core_emitter");
		reg(TileEntityCoreReceiver.class, "tileentity_core_receiver");
		reg(TileEntityCoreInjector.class, "tileentity_core_injector");
		reg(TileEntityCoreStabilizer.class, "tileentity_core_stabilizer");
		reg(TileEntityCore.class, "tileentity_core_core");
		reg(TileEntitySoyuzCapsule.class, "tileentity_soyuz_capsule");
		reg(TileEntitySoyuzLauncher.class, "tileentity_soyuz_launcher");
		reg(TileEntityMachineCrystallizer.class, "tileentity_acidomatic");
		reg(TileEntitySoyuzStruct.class, "tileentity_soyuz_struct");
		reg(TileEntityITERStruct.class, "tileentity_iter_struct");
		reg(TileEntityMachineMiningLaser.class, "tileentity_mining_laser");
		reg(TileEntityProxyInventory.class, "tileentity_proxy_inventory");
		reg(TileEntityProxyEnergy.class, "tileentity_proxy_power");
		reg(TileEntityNukeBalefire.class, "tileentity_nuke_fstbmb");
		reg(TileEntityProxyCombo.class, "tileentity_proxy_combo");
		reg(TileEntityProxyConductor.class, "tileentity_proxy_conductor");
		reg(TileEntityMicrowave.class, "tileentity_microwave");
		reg(TileEntityMachineUUCreator.class, "tileentity_uu_creator");
		reg(TileEntityMachineMiniRTG.class, "tileentity_mini_rtg");
		reg(TileEntityITER.class, "tileentity_iter");
		reg(TileEntityMachinePlasmaHeater.class, "tileentity_plasma_heater");
		reg(TileEntityMachineFENSU.class, "tileentity_fensu");
		reg(TileEntityTrappedBrick.class, "tileentity_trapped_brick");
		reg(TileEntityPlasmaStruct.class, "tileentity_plasma_struct");
		reg(TileEntityMachineLargeTurbine.class, "tileentity_industrial_turbine");
		reg(TileEntitySlidingBlastDoor.class, "tileentity_sliding_blast_door");
		reg(TileEntityKeypadBase.class, "tileentity_keypad_base");
		reg(TileEntitySlidingBlastDoorKeypad.class, "tileentity_keypad_door");
		reg(TileEntityBlackBook.class, "tileentity_book_crafting");
		reg(TileEntityHadronDiode.class, "tileentity_hadron_diode");
		reg(TileEntityHadronPower.class, "tileentity_hadron_power");
		reg(TileEntityHadron.class, "tileentity_hadron");
		reg(TileEntitySolarBoiler.class, "tileentity_solarboiler");
		reg(TileEntitySolarMirror.class, "tileentity_solarmirror");
		reg(TileEntityMachineDetector.class, "tileentity_he_detector");
		reg(TileEntityFireworks.class, "tileentity_firework_box");
		reg(TileEntityMachineIGenerator.class, "tileentity_igenerator");
		reg(TileEntitySiloHatch.class, "tileentity_silo_hatch");
		reg(TileEntitySpinnyLight.class, "tileentity_spinny_light");
		reg(TileEntityControlPanel.class, "tileentity_control_panel");
		reg(TileEntityCrateTungsten.class, "tileentity_crate_tungsten");
		reg(TileEntityDemonLamp.class, "tileentity_demon_lamp");
		reg(TileEntityTurretChekhov.class, "tileentity_turret_chekhov");
		reg(TileEntityTurretJeremy.class, "tileentity_turret_jeremy");
		reg(TileEntityTurretTau.class, "tileentity_turret_tau");
		reg(TileEntityTurretTauon.class, "tileentity_turret_tauon");
		reg(TileEntityTurretFriendly.class, "tileentity_turret_friendly");
		reg(TileEntityTurretRichard.class, "tileentity_turret_richard");
		reg(TileEntityTurretHoward.class, "tileentity_turret_howard");
		reg(TileEntityTurretHowardDamaged.class, "tileentity_turret_howard_damaged");
		reg(TileEntityTurretMaxwell.class, "tileentity_turret_maxwell");
		reg(TileEntityTurretFritz.class, "tileentity_turret_fritz");
		reg(TileEntityTurretBrandon.class, "tileentity_turret_brandon");
		reg(TileEntityRBMKRod.class, "tileentity_rbmk_rod");
		reg(TileEntityRBMKRodReaSim.class, "tileentity_rbmk_rod_reasim");
		reg(TileEntityRBMKControlManual.class, "tileentity_rbmk_control");
		reg(TileEntityRBMKControlAuto.class, "tileentity_rbmk_control_auto");
		reg(TileEntityRBMKBlank.class, "tileentity_rbmk_blank");
		reg(TileEntityRBMKBoiler.class, "tileentity_rbmk_boiler");
		reg(TileEntityRBMKReflector.class, "tileentity_rbmk_reflector");
		reg(TileEntityRBMKAbsorber.class, "tileentity_rbmk_absorber");
		reg(TileEntityRBMKModerator.class, "tileentity_rbmk_moderator");
		reg(TileEntityRBMKOutgasser.class, "tileentity_rbmk_outgasser");
		reg(TileEntityRBMKStorage.class, "tileentity_rbmk_storage");
		reg(TileEntityRBMKConsole.class, "tileentity_rbmk_console");
		reg(TileEntityRBMKCooler.class, "tileentity_rbmk_cooler");
		reg(TileEntityRBMKHeater.class, "tileentity_rbmk_heater");
		reg(TileEntityRBMKCraneConsole.class, "tileentity_rbmk_crane_console");
		reg(TileEntityRBMKInlet.class, "tileentity_rbmk_inlet");
		reg(TileEntityRBMKOutlet.class, "tileentity_rbmk_outlet");
		reg(TileEntityStorageDrum.class, "tileentity_storage_drum");
		reg(TileEntityPileFuel.class, "tileentity_pile_fuel");
		reg(TileEntityPileSource.class, "tileentity_pile_source");
		reg(TileEntityMachineBAT9000.class, "tileentity_machine_bat9000");
		reg(TileEntityMachineOrbus.class, "tileentity_machine_orbus");
		reg(TileEntityCondenser.class, "tileentity_machine_condenser");
		reg(TileEntityMachineAutocrafter.class, "tileentity_machine_autocrafter");
		reg(TileEntityChungus.class, "tileentity_chungus");
		reg(TileEntitySpacer.class, "tileentity_spacer");
		reg(TileEntityMachineFractionTower.class, "tileentity_machine_frac_tower");
		reg(TileEntityTowerSmall.class, "tileentity_tower_small");
		reg(TileEntityTowerLarge.class, "tileentity_tower_large");
		reg(TileEntitySILEX.class, "tileentity_silex");
		reg(TileEntityFEL.class, "tileentity_fel");
		reg(TileEntityHeaterFirebox.class, "tileentity_heater_firebox");
		reg(TileEntityHeaterOven.class, "tileentity_heater_oven");
		reg(TileEntityHeaterOilburner.class, "tileentity_heater_oilburner");
		reg(TileEntityHeaterElectric.class, "tileentity_heater_electric");
		reg(TileEntityHeaterHeatex.class, "tileentity_heater_heatex");
		reg(TileEntityHeaterRadioThermal.class, "tileentity_heater_rt");
		reg(TileEntityFurnaceIron.class, "tileentity_furnace_iron");
		reg(TileEntityFurnaceSteel.class, "tileentity_furnace_steel");
		reg(TileEntityDoorGeneric.class, "tileentity_door_generic");
		reg(TileEntityBMPowerBox.class, "tileentity_bm_power_box");
		reg(TileEntityRadioTorchSender.class, "tileentity_radio_torch_sender");
		reg(TileEntityRadioTorchReceiver.class, "tileentity_radio_torch_receiver");
		reg(TileEntityCraneExtractor.class, "tileentity_craneejector");
		reg(TileEntityCraneInserter.class, "tileentity_craneinserter");
		reg(TileEntityCraneExtractorAlt.class, "tileentity_craneejector_alt");
		reg(TileEntityCraneInserterAlt.class, "tileentity_craneinserter_alt");
		reg(TileEntityCraneSplitter.class, "tileentity_cranesplitter");
		reg(TileEntityCraneBoxer.class, "tileentity_craneboxer");
		reg(TileEntityCraneUnboxer.class, "tileentity_craneunboxer");
		reg(TileEntityCraneRouter.class, "tileentity_cranerouter");
		reg(TileEntityCraneGrabber.class, "tileentity_cranegrabber");
	...
	private static final Set<String> registeredTileIds = new HashSet<String>();

	//Registers a TileEntity under the mod's namespace. The id is world-save NBT data: keep it stable forever and
	//unique. A duplicate id would silently overwrite an earlier registration and quietly corrupt worlds, so fail loud.
	private static void reg(Class<? extends TileEntity> clazz, String id) {
		if(!registeredTileIds.add(id))
			throw new IllegalStateException("Duplicate TileEntity id '" + id + "' (registering " + clazz.getName() + ")");
		GameRegistry.registerTileEntity(clazz, new ResourceLocation(RefStrings.MODID, id));
	}
