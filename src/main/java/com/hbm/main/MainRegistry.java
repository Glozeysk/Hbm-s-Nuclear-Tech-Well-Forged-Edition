...
public class MainRegistry {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		GameRegistry.registerTileEntity(TileEntityConnector.class, new ResourceLocation(RefStrings.MODID, "tileentity_connector_red_wire"));
	...
	public void postInit(FMLPostInitializationEvent event) {
		...
		ModBlocks.postInit();
		BlockCrate.setDrops();
		GasFlareRecipes.registerRecipes();
